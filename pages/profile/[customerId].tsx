...
const CustomerProfile: React.FC = () => {
  ...
  return (
    <html lang="en">
      <head>
        <title>
          Egamlio - Profile- {`${customer.first_name} ${customer.other_names}`}
        </title>
        <link
      ...
      <Header />
          <section className="banner-section inner-banner coach dashboard">
            <div className="overlay">
              <div
                className="banner-content my-banner-container"
                ...
                <div className="row">
                  <div className="col-xxl-3 col-lg-4 col-md-8">
                      ...
                      <ul>
                        <li>
                          <Link href="/dashboard" className="active">
                            <img
                              src="/images/icon/dashboard-menu-1.png"
                              className="max-un"
                              alt="icon"
                            />
                            Dashboard
                        ...
                        <li>
                          <Link href="/dashboard/orders">
                            <img
                              src="/images/icon/dashboard-menu-2.png"
                              className="max-un"
                              alt="icon"
                            />
                            My orders
                        ...
                        <li>
                          <Link href="/dashboard/personal-info">
                            <img
                              src="/images/icon/dashboard-menu-3.png"
                              className="max-un"
                              alt="icon"
                            />
                        ...
                        <li>
                          <Link href="/dashboard/invoices">
                            <img
                              src="/images/icon/dashboard-menu-4.png"
                              className="max-un"
                              alt="icon"
                            />
                            My Invoices
                        ...
                        <li>
                          <Link href="/dashboard/password">
                            <img
                              src="/images/icon/dashboard-menu-6.png"
                              className="max-un"
                              alt="icon"
                            />
                            Change password
                    ...
                    <div className="sidebar-single">
                      ...
                      <p>
                        Just let us know how we can help you and we will try to
